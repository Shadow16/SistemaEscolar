...
namespace EscuelaPrimaria
{
	public partial class Materia
	{
		...
		private global::Gtk.Entry codigoMateria;
		private global::Gtk.Label label12;
		private global::Gtk.Entry areaMat;
		private global::Gtk.Entry nomMat;
		private global::Gtk.Label label11;
		private global::Gtk.Label label13;
		private global::Gtk.SpinButton horasMat;
		...
		protected virtual void Build ()
		{
			...
			// Widget EscuelaPrimaria.Materia
			this.Name = "EscuelaPrimaria.Materia";
			this.Title = global::Mono.Unix.Catalog.GetString ("Materia");
			this.WindowPosition = ((global::Gtk.WindowPosition)(1));
			this.Resizable = false;
			// Container child EscuelaPrimaria.Materia.Gtk.Container+ContainerChild
			...
			this.image2.Pixbuf = global::Gdk.Pixbuf.LoadFromResource ("EscuelaPrimaria.Imagenes.Materia.png");
			...
			this.label7.LabelProp = global::Mono.Unix.Catalog.GetString ("Especifique la Materia Nueva");
			...
			this.label8.LabelProp = global::Mono.Unix.Catalog.GetString ("Código Materia:");
			this.fixed5.Add (this.label8);
			global::Gtk.Fixed.FixedChild w23 = ((global::Gtk.Fixed.FixedChild)(this.fixed5 [this.label8]));
			w23.X = 299;
			w23.Y = 322;
			// Container child fixed5.Gtk.Fixed+FixedChild
			this.codigoMateria = new global::Gtk.Entry ();
			this.codigoMateria.WidthRequest = 105;
			this.codigoMateria.CanFocus = true;
			this.codigoMateria.Name = "codigoMateria";
			this.codigoMateria.IsEditable = true;
			this.codigoMateria.InvisibleChar = '●';
			this.fixed5.Add (this.codigoMateria);
			global::Gtk.Fixed.FixedChild w24 = ((global::Gtk.Fixed.FixedChild)(this.fixed5 [this.codigoMateria]));
			w24.X = 398;
			w24.Y = 319;
			// Container child fixed5.Gtk.Fixed+FixedChild
			...
			w25.Y = 321;
			// Container child fixed5.Gtk.Fixed+FixedChild
			this.areaMat = new global::Gtk.Entry ();
			this.areaMat.WidthRequest = 113;
			this.areaMat.CanFocus = true;
			this.areaMat.Name = "areaMat";
			this.areaMat.IsEditable = true;
			this.areaMat.InvisibleChar = '●';
			this.fixed5.Add (this.areaMat);
			global::Gtk.Fixed.FixedChild w26 = ((global::Gtk.Fixed.FixedChild)(this.fixed5 [this.areaMat]));
			w26.X = 546;
			w26.Y = 317;
			// Container child fixed5.Gtk.Fixed+FixedChild
			this.nomMat = new global::Gtk.Entry ();
			this.nomMat.CanFocus = true;
			this.nomMat.Name = "nomMat";
			this.nomMat.IsEditable = true;
			this.nomMat.InvisibleChar = '●';
			this.fixed5.Add (this.nomMat);
			global::Gtk.Fixed.FixedChild w27 = ((global::Gtk.Fixed.FixedChild)(this.fixed5 [this.nomMat]));
			w27.X = 398;
			w27.Y = 354;
			// Container child fixed5.Gtk.Fixed+FixedChild
			this.label11 = new global::Gtk.Label ();
			this.label11.Name = "label11";
			this.label11.LabelProp = global::Mono.Unix.Catalog.GetString ("Nombre Materia:");
			...
			w29.Y = 358;
			// Container child fixed5.Gtk.Fixed+FixedChild
			this.horasMat = new global::Gtk.SpinButton (0D, 100D, 1D);
			this.horasMat.CanFocus = true;
			this.horasMat.Name = "horasMat";
			this.horasMat.Adjustment.PageIncrement = 10D;
			this.horasMat.ClimbRate = 1D;
			this.horasMat.Numeric = true;
			this.fixed5.Add (this.horasMat);
			global::Gtk.Fixed.FixedChild w30 = ((global::Gtk.Fixed.FixedChild)(this.fixed5 [this.horasMat]));
			w30.X = 603;
			w30.Y = 353;
			// Container child fixed5.Gtk.Fixed+FixedChild
			...
			this.agregar.Label = global::Mono.Unix.Catalog.GetString ("Agregar Nueva materia");
			...
			this.label14.LabelProp = global::Mono.Unix.Catalog.GetString ("Materias Alumno");
			...
			this.nodeMateria.WidthRequest = 138;
			this.nodeMateria.HeightRequest = 177;
			this.nodeMateria.CanFocus = true;
			this.nodeMateria.Name = "nodeMateria";
			this.GtkScrolledWindow2.Add (this.nodeMateria);
			...
			this.eliminar.Label = global::Mono.Unix.Catalog.GetString ("Eliminar Materia");
