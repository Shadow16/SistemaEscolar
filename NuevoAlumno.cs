...
{
	public partial class NuevoAlumno : Gtk.Window
	{
		private Cordinacion padre;
		public NuevoAlumno (Cordinacion padre) : 
		...
		protected void OnGuardarClicked (object sender, EventArgs e)
		{
			try 
			{
				...
				if(codigo == "" || nombre == "" || telefono == "" || apellidoP  == "" || apellidoM == "" || calle == "" || numero == "" || numeroInt == "" || 
					...
					this.abrirConexion();
					string sql = "INSERT INTO `Estudiante` (`codigo`, `nombre`, `apellidoP`, `apellidoM`, `calle`, `numero`, `numeroInt`, `ciudad`, `colonia`, `telefono`, `avisarA`, `telEm`, `usuario`, `password`) " +
