...
{
	public partial class Cursos : Gtk.Window
	{
		private Cordinacion padre;
		public Cursos (Cordinacion padre) : 
		...
		protected void OnPagarClicked (object sender, EventArgs e)
		{
			...
			string codigo = codigoCurso.Text;
			string nombre = nomCur.Text;
			string area = areaCur.Text;
			string horas = horasCur.Text;
			...
			if(codigo == "" || area == "" || nombre == "" || horas  == "0" || id_Estudiante  == "" || id_Maestro  == ""){
				...
				this.abrirConexion();
				string sql = "INSERT INTO `Cursos` (`id_Estudiante`, `id_Maestro`, `codigo`, `nombre`, `area`, `horas`) " +
